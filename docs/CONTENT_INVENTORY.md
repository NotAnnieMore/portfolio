...
- official thesis title and degree;
- research question and context;
- dataset provenance and whether it can be discussed publicly;
- methods and models used;
- evaluation approach and verified results;
- relationship between the two repositories;
- diagrams or outputs suitable for public screenshots;
- concrete lessons and future work.
